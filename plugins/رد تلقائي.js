let handler = m => m 
 ...
     conn.reply(m.chat,`*🐧احتين عند ام حسين *`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 } 

if (/^عمر|ناروتو|لايت$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*🐒⚡عمك وعم عيالك*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}

   if (/^عبيط|يا عبيط|اهبل|غبي$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*🗿بطل تنمر ياض*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   }
   
if (/^انت بوت؟|انت بوت|هل انت بوت؟|هل انت بوت|من انت؟$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*🐧انت شايف يسطا*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
   
   if (/^منور|منوره$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*🐒بنوري ياورع*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   }
    if (/^مين عمك$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*🐒عمامي 𝐿𝐼𝑇𝐸 و 𝑁𝐴𝑅𝑈𝑇𝛩*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
    } 

    if (/^بوت$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*♥️🐒اسمي ايتاتشي يابرو*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
     conn.reply(m.chat, `*🐒قول نعم يسطا*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   ...
   if (/^رونالدو$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat,'*عم العالم ♥🌚*',m) //wm, null, [['Menu', '#menu']], m) botones :v
 ...
 if (/^بحبك يا ايتاتشي|بموت فيك يا ايتاتشي$/i.test(m.text) ) { //sem prefixo 
 ...
     conn.reply(m.chat, `*🐧احا يعم مقولنا بنوري انا*`, m) //wm, null, [['Menu', '#menu']], m) botones :V
 ...
     conn.reply(m.chat, `*🙌♥️شغال يا حب*`, m) //wm, null, [['Menu', '#menu']], m) botones :V
 ...
     conn.reply(m.chat, `*🗿يعم غور روح نام *`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
 if (/^ايتاتشي |ايتاشي$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat,`*🐒♥️منور ياقلب ايتاتشي*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
