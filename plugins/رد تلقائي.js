let handler = m => m 
 ...
     conn.reply(m.chat,`*احتين عند ام حسين 🌚☠️*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 } 

if (/^عمر|المزعج|لايت$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*عمك وعم عيالك 🌚♥️*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}

   if (/^عبيط|يا عبيط|اهبل|غبي$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*بطل تنمر ياعلق 🗿*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   }
   
if (/^ايتادوري|شواحة|بابلو|جوست|بلاك$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `* صديق لايت الروح ب الروح 🌚♥️ *`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
 ...
     conn.reply(m.chat, `*اسمي لايت ياعم النطع انت 🗿*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
      
    }
 if (/^يب$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `*قول نعم ياض🗿☠️*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
     conn.reply(m.chat,'*عيب يا قليل الادب ياللي ماتربيتش ☠️*', m) //wm, null, [['Menu', '#menu']], m) botones :V
 ...
     conn.reply(m.chat, `*شغال يا حب ☠️🗿*`, m) //wm, null, [['Menu', '#menu']], m) botones :V
 ...
     conn.reply(m.chat, `*خخخخ مش بمزاجك ياخول 🗿*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
 if (/^لايت|لايت$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat,`*قلب لايت اطلب 🌚♥️*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
     conn.reply(m.chat, `*الشارع الي وراه 🌚☠️*`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
